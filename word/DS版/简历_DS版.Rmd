...
+ Selected key statistics and collaborated with a team to built multi-dimensional public BI dashboards; Visualized and evaluated health of a SaaS system resulting in a 5% growth of customers
...
+ Worked alongside product managers to optimize product design and user experience using error logs data leading to a reduction of bug rate by 7%; Upgraded and tested data product in a SaaS system during developing schedule

+ Wrote ETL shell scripts to aggregate original detailed data into intermediate tables to optimize query performance by 85% and successfully automate daily reports; Reduced human-power input and time cost
...
**Kaggle** [**M5 Forecasting - Accuracy**](https://www.kaggle.com/c/m5-forecasting-accuracy) \qquad 103rd/5558 \ Top2% \ Silver Medal \hfill Mar 2020 ~ Jun 2020    
